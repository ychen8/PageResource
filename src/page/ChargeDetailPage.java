...
public class ChargeDetailPage extends UiAutomatorTestCase implements ChargeDetailConstants{
	...
	public Boolean payStatusTextExist(){
		return chargedetailpage.isExistFromClass(VIEW_CLASS, PAY_STATUS_TEXT_ID);
	}
	//获取支付状态-文本
	public String payStatusTextText(){
	    return chargedetailpage.getTextFromClass(VIEW_CLASS, PAY_STATUS_TEXT_ID);
	}
	//判断支付状态是否存在
	...
	public Boolean yuanExist(){
		return chargedetailpage.isExistFromClass(VIEW_CLASS,YUAN_ID);
	}
	//获取元-文本
	public String yuanText(){
	    return chargedetailpage.getTextFromClass(VIEW_CLASS,YUAN_ID);
	}
	//判断明细列表是否存在
	...
	public Boolean costNameExist(int index){
		return chargedetailpage.isExistFromId(COST_LIST, index);
	}
	//获取费用项名称
	public String costNameText(int index){
		return chargedetailpage.getTextFromId(COST_LIST, index);
	}
