...
public interface LoginConstants {
	...
	//手机号
	static String PHONE="com.szzc.ucar.driver:id/login_phone";
	//司机ＩＤ
	static String DRIVERID="com.szzc.ucar.driver:id/login_driver_id";
	//密码
	static String PASSWORD="com.szzc.ucar.driver:id/login_password";
	//登录按钮
