...
public interface PersonManageConstants {
	...
	//基本信息栏
	static String LL_BASE_INFO="com.szzc.ucar.driver:id/ll_base_info";
	//查看基本信息
	static String TXT_BASE_INFO="com.szzc.ucar.driver:id/txt_base_info";
	//查看基本信息-index
	static int INDEX_TXT_BASE_INFO=0;
	//基本信息内容－司机姓名
	static String TXT_DRIVER_NAME="com.szzc.ucar.driver:id/txt_driver_name";
	//基本信息内容－司机姓名-INDEX
	static int INDEX_TXT_DRIVER_NAME=1;
	//私人电话栏
	static String LL_PRIVATE_PHONE="com.szzc.ucar.driver:id/ll_private_phone";
	//私人电话-index
	static int INDEX_PRIVATE_PHONE=0;
	//私人电话文本值
